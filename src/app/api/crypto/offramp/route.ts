...
export async function GET(request: NextRequest) {
  try {
    ...
    // Get offramp supported cryptos
    const cryptos = await CryptoService.getOfframpCryptos(paymentMethod, currency);
    ...
    console.error('Error fetching offramp cryptos:', error);
